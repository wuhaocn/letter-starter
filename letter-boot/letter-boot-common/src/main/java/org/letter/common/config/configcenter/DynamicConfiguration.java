...
import org.letter.common.config.Configuration;

import java.util.Collections;
import java.util.Set;
import java.util.SortedSet;

import static org.letter.common.config.configcenter.DynamicConfigurationFactory.getDynamicConfigurationFactory;
...
public interface DynamicConfiguration extends Configuration, AutoCloseable {
     ...
     * specifies at startup or 'letter' by default. This method will only register listener, which means it will not
     ...
     * such as a complete letter.properties file.
     */
    ...
    /**
     * This method are mostly used to get a compound config file, such as a complete letter.properties file.
     *
     * @revision 2.7.4
     */
     ...
     *
     * @return The default value is {@link #DEFAULT_GROUP "letter"}
     * @since 2.7.5
     */
