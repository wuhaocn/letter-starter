...
public interface Listenable<E extends EventListener<?>> {
    ...
    /**
     * Add a {@link EventListener letter event listener}
     *
     * @param listener a {@link EventListener letter event listener}
    ...
    /**
     * Add one or more {@link EventListener letter event listeners}
     *
     * @param listener a {@link EventListener letter event listener}
     * @param others   an optional {@link EventListener letter event listeners}
    ...
    /**
     * Add multiple {@link EventListener letter event listeners}
     *
     * @param listeners the {@link EventListener letter event listeners}
    ...
    /**
     * Remove a {@link EventListener letter event listener}
     *
     * @param listener a {@link EventListener letter event listener}
    ...
    /**
     * Remove all {@link EventListener letter event listeners}
     *
    ...
    /**
     * Get all registered {@link EventListener letter event listeners}
     *
     * @return non-null read-only ordered {@link EventListener letter event listeners}
