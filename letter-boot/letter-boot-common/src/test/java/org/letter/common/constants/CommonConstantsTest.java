...
import static org.letter.common.constants.CommonConstants.*;
...
public class CommonConstantsTest {
    ...
    public void test() {
        ...
        assertEquals("META-INF/letter/service-name-mapping.properties", DEFAULT_SERVICE_NAME_MAPPING_PROPERTIES_PATH);
    }
}
