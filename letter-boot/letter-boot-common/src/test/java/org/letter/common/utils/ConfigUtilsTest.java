...
//    }
    ...
    public void testGetProperties1() throws Exception {
        try {
            System.setProperty(CommonConstants.letter_PROPERTIES_KEY, "properties.load");
            ...
            System.clearProperty(CommonConstants.letter_PROPERTIES_KEY);
        }
    }
    ...
    public void testGetProperties2() throws Exception {
        System.clearProperty(CommonConstants.letter_PROPERTIES_KEY);
        Properties p = ConfigUtils.getProperties();
        assertThat((String) p.get("letter"), equalTo("properties"));
    }
    ...
    public void testGetProperty() throws Exception {
        assertThat(ConfigUtils.getProperty("letter"), equalTo("properties"));
    }
    ...
    public void testGetPropertyFromSystem() throws Exception {
        try {
            System.setProperty("letter", "system");
            assertThat(ConfigUtils.getProperty("letter"), equalTo("system"));
        } finally {
            System.clearProperty("letter");
        }
    }
    ...
    public void testGetSystemProperty() throws Exception {
        try {
            System.setProperty("letter", "system-only");
            assertThat(ConfigUtils.getSystemProperty("letter"), equalTo("system-only"));
        } finally {
            System.clearProperty("letter");
        }
    }
    ...
    public void testLoadProperties() throws Exception {
        Properties p = ConfigUtils.loadProperties("letter.properties");
        assertThat((String)p.get("letter"), equalTo("properties"));
    }
    ...
    public void testLoadPropertiesOneFileNotRootPath() throws Exception {
        Properties p = ConfigUtils.loadProperties("META-INF/letter/internal/org.letter.common.threadpool.ThreadPool", false);

        Properties expected = new Properties();
        expected.put("fixed", "org.letter.common.threadpool.support.fixed.FixedThreadPool");
        expected.put("cached", "org.letter.common.threadpool.support.cached.CachedThreadPool");
        expected.put("limited", "org.letter.common.threadpool.support.limited.LimitedThreadPool");
        expected.put("eager", "org.letter.common.threadpool.support.eager.EagerThreadPool");
    ...
    public void testLoadPropertiesMultiFileNotRootPath() throws Exception {
        ...
        Properties p = ConfigUtils.loadProperties("META-INF/letter/internal/org.letter.common.status.StatusChecker", true);
...
//        assertEquals(expected, p);
    ...
    public void testPropertiesWithStructedValue() throws Exception {
        ...
        Properties expected = new Properties();
        expected.put("letter.parameters", "[{a:b},{c_.d: r*}]");
