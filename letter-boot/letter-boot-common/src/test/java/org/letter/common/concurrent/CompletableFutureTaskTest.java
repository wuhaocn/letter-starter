 ...
 */
package org.letter.common.concurrent;

import org.letter.common.utils.NamedThreadFactory;
...
public class CompletableFutureTaskTest {
    ...
    private static final ExecutorService executor = new ThreadPoolExecutor(0, 10, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), new NamedThreadFactory("letterMonitorCreator", true));
