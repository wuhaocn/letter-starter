 ...
 */
package org.letter.common.extension.ext7;

import org.letter.common.URL;
import org.letter.common.extension.SPI;

/**
 * Test scenario for letter-144: extension load failure when third-party dependency doesn't exist. If extension is not
